        ...
        <div class="container">
            <div class="row">
                <!-- <div class="footer-col">
                    ...
                    <h5>Brahmaputra Community Radio Station, (Radio Brahmaputra 90.4 MHz) is the first grassroots
                        community radio station of North East India situated in district Dibrugarh, Assam, India. It has
                        been set up to cater the communication needs of marginalized communities: those living in media
                        dark regions such as islands, tea garden and other villages and those speaking local languages
                        and dialects which mainstream media do not include as part of programs</h5>
                    <p><a href="mailto:contactradiobrahmaputra@gmail.com">contactradiobrahmaputra@gmail.com</a></p>
                    <p>+91-9957722184; +91-9954489439</p>
                </div> -->
                <div class="footer-col">
                    <h4>Out Networks</h4>
                    <ul>
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Project/Program</a></li>
