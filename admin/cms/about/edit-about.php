        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                if (isset($_POST['submit'])) {
                    $about1 = mysqli_escape_string($con, $_POST['about1']);
                    $about2 = mysqli_escape_string($con, $_POST['about2']);
                    $about3 = mysqli_escape_string($con, $_POST['about3']);
                    $about4 = mysqli_escape_string($con, $_POST['about4']);
                    $about5 = mysqli_escape_string($con, $_POST['about5']);
